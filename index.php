...
$r=mysqli_query($con,"SELECT count(*) as total from instructor ");
$d=mysqli_fetch_assoc($r);
$cattt=$d['total'];



$r=mysqli_query($con,"SELECT count(*) as total from instructor where status='0'");
$d=mysqli_fetch_assoc($r);
$caatt=$d['total'];


$r=mysqli_query($con,"SELECT count(*) as total from instructor where status='1'");
$d=mysqli_fetch_assoc($r);
$caattt=$d['total'];
...
echo "<div class='col-lg-4'>";
echo "<a href='index.php?option=Instructor'><h3 style='color:#fff;width:250px' class='btn btn-success'>Total Registered Teacher :  $cattt</h3></a><hr/>";
echo "</div>";


echo "<div class='col-lg-4'>";
echo "<a href='index.php?option=Instructor'><h3 style='color:#fff;width:250px' class='btn btn-success'>Total Active Teacher :  $caatt</h3></a><hr/>";
echo "</div>";


echo "<div class='col-lg-4'>";
echo "<a href='index.php?option=Instructor'><h3 style='color:#fff;width:250px' class='btn btn-success'>Total Deactive Teacher :  $caattt</h3></a>";
echo "</div>";
...
if( $pagi > 0 )
 {
         $last = $pagi - 2;
      echo "<a href = \"index.php?o&pagi=$last\">Last 10 Records</a> |";
        echo "<a href = \"index.php?&pagi=$pagi\">Next 10 Records</a>";
     ...
     echo "<a href = \"index.php?&pagi=$pagi\">Next 10 Records</a>";
            ...
            $last = $pagi - 2;
            echo "<a href = \"index.php?&pagi=$last\">Last 10 Records</a>";
         }
        echo "</td></tr>"; 
		?>
