...
<div class="panel-body">
 ...
 <div class="form-group">
    <button name="signup" class="btn btn-success" style="width:150px; float:left; margin-left:30%" type="submit"><span class="glyphicon glyphicon-log-in"></span> Login</button>
      </div>
