 ...
 if(isset($signup))
 {
	...
	$course=implode(",",$course);
	 ...
	 mysqli_query($con,"insert into student values('','$n','$e',password('$pass'),'$mob','$g','$prog','$course','1')");
...
<div class="col-sm-6">
<div class="form-group">
    <label for="exampleInputEmail1">Lecture/Subject</label>
...
<div class="col-sm-4">
         ...
         <button name="signup" class="btn btn-success" type="submit" style="width:175px">Add New Student</button>
</form>	
	</div>
	</div>
</div>